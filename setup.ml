...
(* OASIS_START *)
(* DO NOT EDIT (digest: cc44c8edc0e74bfbe18a9311107a2e2d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://github.com/xvw/jsoo_storage";
          bugreports = None;
          synopsis = "A Js_of_OCaml wrapper of the WebStorage API";
          description =
            Some
              [OASISText.Para "Another approach to webstorage in Js_of_OCaml"
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("js_of_ocaml",
                               Some (OASISVersion.VGreaterEqual "2.8.4"));
                   ...
                   {
                      lib_modules = ["WebStorage"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "jsoo_storage";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/jsoo_storage";
                      doc_title =
                        "Documentation and API reference for Jsoo_storage";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/xvw/jsoo_storage.git";
                      src_repo_browser =
                        Some "https://github.com/xvw/jsoo_storage";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "x\031T\002?\231t\028\132\208\153\150\242e3y";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
