(* OASIS_START *)
(* DO NOT EDIT (digest: 68d59004fc6c1d031cc1bc3f8041732b) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("jsoo_storage", ["src"], [])];
     lib_c = [];
     flags =
       [
          (["oasis_library_jsoo_storage_byte"; "ocaml"; "link"; "byte"],
            [
               (OASISExpr.EBool true,
                 S [A "-g"; A "-w"; A "+a-4-40..42-44-45-48"])
            ]);
          (["oasis_library_jsoo_storage_byte"; "ocaml"; "ocamldep"; "byte"],
            [
               (OASISExpr.EBool true,
                 S [A "-g"; A "-w"; A "+a-4-40..42-44-45-48"])
            ]);
          (["oasis_library_jsoo_storage_byte"; "ocaml"; "compile"; "byte"],
            [
               (OASISExpr.EBool true,
                 S [A "-g"; A "-w"; A "+a-4-40..42-44-45-48"])
            ])
